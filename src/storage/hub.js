...
function makeV1GaiaAuthToken(hubInfo: Object, signerKeyHex: string, hubUrl: string, scopes?: Array<AuthScopeType>): string {
...
export function connectToGaiaHub(gaiaHubUrl: string,
  ...
  return fetch(`${gaiaHubUrl}/hub_info`)
    ...
    .then((hubInfo) => {
      ...
      const token = makeV1GaiaAuthToken(hubInfo, challengeSignerHex, gaiaHubUrl, scopes)
